...
\usepackage{tikz}
%\usetikzlibrary{shadows} % Para sombras simples
\usetikzlibrary{shadows.blur} % Para sombras com desfoque
\usepackage{afterpage} % É utilizado com o comando \afterpage para inserir o conteúdo na próxima página disponível, mantendo o fluxo do texto.
\usepackage{pgffor}    % Necessário para o comando \foreach
%\usepackage{calc}
\usepackage{array} % Para melhor controle de colunas em ambientes tabulares
\usepackage{pgfplotstable} % Se precisar ler do CSV diretamente
\usepackage{fancyhdr}
\pagestyle{fancy}
...
\begin{document}
    ...
    %++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    %\input{Caps/todo.tex} % Pendências do documento
    % Elementos textuais
    \textual
