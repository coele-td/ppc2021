...
\toprule
% Cabeçalho
\multicolumn{3}{p{7cm}}{\thead{Segundo Período}} & \multicolumn{5}{p{7cm}}{\thead{Carga horária (h)}}\\ \cmidrule(lr){1-3} \cmidrule(lr){4-8}
...
\makecell{Ciclo de \\Humanidades}       & \makecell{Comunicação \\ Linguística}                 &           & 30        & -         & -             & -             & 30 \\
