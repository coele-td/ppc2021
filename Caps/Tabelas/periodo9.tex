...
\toprule
% Cabeçalho
\multicolumn{3}{p{7cm}}{\thead{Nono Período}} & \multicolumn{5}{p{7cm}}{\thead{Carga horária (h)}}\\ \cmidrule(lr){1-3} \cmidrule(lr){4-8}
...
\makecell{-}                                                        & \makecell{Trabalho de \\Conclusão de Curso 1}                     &           & -         & -         & 15            & 45            & 60 \\
