...
\begin{quadro}
	...
	columns/Instituição/.style={string type},
	columns/Curso/.style={string type},
	columns/Cidade/.style={string type},
	columns/Distância/.style={string type}
	]%
	{Caps/Quadros/cusos_prox.csv}
	\label{qua:cursoskm}
\end{quadro}
...
\begin{quadro}
	...
	\newcolumntype{C}{>{\centering\arraybackslash}p{0.25\textwidth}}% a centered fixed-width-column
	\newcolumntype{D}{>{\centering\arraybackslash}p{0.75\textwidth}}% a centered fixed-width-column
	...
	columns/Nome do curso/.style={string type, column type=|C},	
	columns/Engenharia Eletrônica/.style={string type, column type=|D|}	
	]%
	{Caps/Quadros/quadro_geral.csv}
	\label{qua:geral}
\end{quadro}
