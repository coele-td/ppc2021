...
O NDE constitui-se de um grupo de docentes, com atribuições acadêmicas de acompanhamento, atuante no processo de concepção, avaliação, solidificação e contínua atualização do Projeto Pedagógico do Curso (PPC). Este grupo é caracterizado por ser responsável pela formulação, implementação e desenvolvimento do PPC. No ambito institucional, a Resolução N\textordmasculine 9/12-COGEP, de 13 de abril de 2012 \cite{cogep9} institui o Regulamento Do Núcleo Docente Estruturante Dos Cursos De Graduação da UTFPR.
