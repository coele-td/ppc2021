...
A estrutura apresentada, propõe a intencionalidade em trabalhar habilidades e atitudes do futuro engenheiro. O corpo docente, com sua experiência adquirida, permitirá momentos de aprendizagem relacionados ao desenvolvimento dessas habilidades e atitudes por meio de um projeto de currículo para esse fim.
...
\begin{figure}[hbt!]
	...
	\quadroUnitCurricularLegenda{yellow}
	\fonte{\utf}
	\label{fig:legenda}
\end{figure}
...
\nomenclature[A]{AD}{Aulas à distância}
...
\nomenclature[A]{COEMP}{Conselho de Relações Empresariais e Comunitárias}
...
Dessa forma, a unidade curricular de Desenho Técnico (\autoref{qua:ucEET41A}), por proporcionar os conceitos básicos sobre traços, projeções, cortes e perspectivas, foi classificada na área de desenho industrial.

A unidade curricular de Introdução à Engenharia, por apresentar em sua ementa elementos que tratam de aspectos históricos e filosóficos do profissão do engenheiro, foi elencada como integrante do ciclo de humanidades.
...
\nomenclature[A]{NUINT}{Núcleo Interdisciplinar}
...
O Trabalho de Conclusão de Curso (TCC) é um componente curricular obrigatório para os cursos de graduação \cite{dcneng}. No âmbito da UTFPR, o TCC deve atender à resolução n\textordmasculine 180/2022 – COGEP/UTFPR, Regulamento do Trabalho de Conclusão de Curso (TCC) para os Cursos de Graduação da UTFPR \cite{cogep180}. Os objetivos do TCC são:
...
\begin{enumerate}
	...
	\item Estimular a inovação tecnológica, por meio da transferência de tecnologia, desenvolvimento de patentes e/ou comercialização dos resultados;
...
\nomenclature[A]{ACs}{Atividades Complementares}
...
É possível notar, por meio da referida tabela, que o curso atende à Resolução CNE/CES N\textordmasculine{} 7, de 18 de dezembro de 2018, que determina um mínimo de 10$\%$ da carga horária do curso, voltada para atividades extensionistas.
...
\begin{itemize}
	...
	\item Metodologias ativas: o discente é o principal responsável pelo aprendizado do conteúdo por meio da participação, interagindo e pensando para aumentar a absorção. Pode-se utilizar estudos de caso, projetos práticos e debates entre equipes de discentes. É o contrario da metodologia passiva, onde o discente apenas assiste as aulas expositivas e depois é avaliado por meio de provas e trabalhos;
...
\begin{itemize}
	...
	\item Aproveitamento: os alunos serão avaliados por atividades que resultem na avaliação do conhecimento por atribuição de notas a critério do professor e segundo o plano de ensino da disciplina. A flexibilização do regimento da Instituição permite que o professor possa alterar os critérios propostos conforme a necessidade de cada disciplina;
