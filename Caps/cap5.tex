...
\begin{table}[htb!]
	...
	\label{tab:per1}
	\input{Caps/Tabelas/periodo1.tex}	
\end{table}

% dados estruturais de desenho técnico
\begin{quadro}[htb!]
	\centering\tiny
	\caption{Desenho Técnico}
	\label{qua:desenho}
	\input{Caps/Quadros/Disciplinas/desenho.quadro.tex}	
\end{quadro}

% dados estruturais de calculo diferencial integral
\begin{quadro}[htb!]
	\centering\tiny
	\caption{Cálculo Diferencial Integral 1}
	\label{qua:calculo1}
	\input{Caps/Quadros/Disciplinas/calculo1.quadro.tex}	
\end{quadro}
...
\begin{table}[htb!]
	...
	\label{tab:per2}
	\input{Caps/Tabelas/periodo2.tex}
\end{table}
...
\begin{table}[htb!]
	...
	\label{tab:per3}
	\input{Caps/Tabelas/periodo3.tex}	
\end{table}
...
\begin{table}[htb!]
	...
	\label{tab:per4}
	\input{Caps/Tabelas/periodo4.tex}	
\end{table}
...
\begin{table}[htb!]
	...
	\caption{Conteúdos Curriculares do Quarto Período}
	\label{tab:per5}
	\input{Caps/Tabelas/periodo5.tex}
...
\begin{table}[htb!]
	...
	\caption{Conteúdos Curriculares do Quarto Período}
	\label{tab:per6}
	\input{Caps/Tabelas/periodo6.tex}
...
\begin{table}[htb!]
	...
	\label{tab:per7}
	\input{Caps/Tabelas/periodo7.tex}
...
\begin{table}[htb!]
	...
	\label{tab:per8}
	\input{Caps/Tabelas/periodo8.tex}
...
\begin{table}[htb!]
	...
	\label{tab:per9}
	\input{Caps/Tabelas/periodo9.tex}
...
\begin{table}[htb!]
	...
	\label{tab:per10}
	\input{Caps/Tabelas/periodo10.tex}
