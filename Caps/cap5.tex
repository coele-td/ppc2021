...
Os conteúdos curriculares optativos de Humanidades estão listados na \autoref{tab:per31}. Adicionalmente, a estrutura de cada unidade curricular é apresentada em quadros: \listaUC{31}{Dados/unidadesCurriculares.csv}.
