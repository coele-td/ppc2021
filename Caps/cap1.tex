...
\nomenclature[A]{IBGE}{Instituto Brasileiro de Geografia e Estatística}
...
%\subsection{Quarta atualização na matriz curricular}

%- Revisão e considerável reescrita do PPC em obediência à  Resolução nº 27/2020 - COGEP, de 01 de julho de 2020;
%- Curricularização da extensão, por meio da modificação das disciplinas de sistemas digitais, microcontroladores e sistemas embarcados como extensionistas, totalizando 345 horas de atividades extensionistas, em atendimento às DCNs;
%- Curricularização da extensão, por meio da adicção de 45 horas de extensão na modalidade de apostilamento, em atendimento às DCNs;
%- Estabelecimento do ciclo de humanidades contendo 225 horas de disciplinas optativas, em atendimento à Resolução COGEP/UTFPR Nº 142, DE 25 DE FEVEREIRO DE 2022;
%- Remoção das disciplinas de mecânica geral 2 e princípio de resistências dos materiais;
%- Atualização das disciplinas de programação devido a sombreamentos e adicção de arquitetura de computadores e sistemas operacionais;
%- Inserção das competências profissionais, conforme estabelece as DCNs.
